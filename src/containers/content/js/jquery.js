...
!(function (a, b) {
  ...
  (m.fn = m.prototype = {
    ...
    let a,
      ...
      j = !1;
    for (
      typeof g === 'boolean' && ((j = g), (g = arguments[h] || {}), h++), typeof g === 'object' ||
        m.isFunction(g) ||
        (g = {}), h === i && ((g = this), h--);
      i > h;
      h++
    ...
    makeArray(a, b) {
      const c = b || [];
      return a != null &&
        (r(Object(a)) ? m.merge(c, typeof a === 'string' ? [a] : a) : f.call(c, a)), c;
    },
    inArray(a, b, c) {
      let d;
      if (b) {
  ...
  const s = (function (a) {
    ...
    (c = fb.support = {}), (f = fb.isXML = function (a) {
      ...
      return e !== n && e.nodeType === 9 && e.documentElement
        ? (
            ...
            (c.getElementsByClassName =
              ...
              ib(
                a => (a.innerHTML = "<div class='a'></div><div class='a i'></div>"),
      ...
      filter: {
        ...
        PSEUDO(a, b) {
          let c,
            e =
              d.pseudos[a] || d.setFilters[a.toLowerCase()] || fb.error(`unsupported pseudo: ${a}`);
          return e[u]
            ? e(b)
            : e.length > 1
              ? (
      ...
      pseudos: {
        ...
        lang: hb(
          a => W.test(a || '') || fb.error(`unsupported lang: ${a}`),
          (a = a.replace(cb, db).toLowerCase()),
          (b) => {
            let c;
            do {
              if ((c = p ? b.lang : b.getAttribute('xml:lang') || b.getAttribute('lang')))                { return (c = c.toLowerCase()), c === a || c.indexOf(`${a}-`) === 0; }
    ...
    return (h = fb.compile = function (a, b) {
      ...
      u.split('').sort(B).join('') === u), (c.detectDuplicates = !!l), m(), (c.sortDetached = ib(
  ...
  m.extend({
    ...
    index(a) {
      return a
        ? typeof a === 'string' ? m.inArray(this[0], m(a)) : m.inArray(a.jquery ? a[0] : a, this)
        ...
        try {
          c =
            c === 'true'
              ...
              : c === 'false'
                ? !1
                : c === 'null' ? null : `${+c}` === c ? +c : M.test(c) ? m.parseJSON(c) : c;
        } catch (e) {}
        m.data(a, b, c);
      } else c = void 0;
    }
    ...
    if (m.acceptData(a)) {
      ...
      if ((k && j[k] && (e || j[k].data)) || void 0 !== d || typeof b !== 'string') {
        return k || (k = i ? (a[h] = c.pop() || m.guid++) : h), j[k] ||
          (j[k] = i ? {} : { toJSON: m.noop }), (typeof b === 'object' || typeof b === 'function') &&
      ...
      if (g[h]) {
        if (b && (d = c ? g[h] : g[h].data)) {
          m.isArray(b)
            ...
            : b in d ? (b = [b]) : ((b = m.camelCase(b)), (b = b in d ? [b] : b.split(' '))), (e =
            b.length);
  ...
  m.extend({
    ...
    dequeue(a, b) {
      ...
      e === 'inprogress' && ((e = c.shift()), d--), e &&
        (b === 'fx' && c.unshift('inprogress'), delete f.stop, e.call(a, g, f)), !d &&
        f &&
        f.empty.fire();
    },
    _queueHooks(a, b) {
  ...
  (m.event = {
    ...
    fix(a) {
      ...
      return a.target || (a.target = f.srcElement || y), a.target.nodeType === 3 &&
    ...
    m.each({ focus: 'focusin', blur: 'focusout' }, (a, b) => {
      ...
      off(a, b, c) {
        ...
        return (b === !1 || typeof b === 'function') && ((c = b), (b = void 0)), c === !1 &&
        (c = bb), this.each(function () {
        ...
        if ((b || m.acceptData(d)) && ((f = d[i]), (g = f && j[f]))) {
          ...
          j[f] &&
            (
              ...
              l
                ? delete d[i]
                : typeof d.removeAttribute !== K ? d.removeAttribute(i) : (d[i] = null),
              c.push(f)
            );
        }
      }
    ...
    domManip(a, b) {
      ...
      if (
        ...
        for (g = m.map(ub(i, 'script'), xb), f = g.length; l > j; j++) {
          (d = i), j !== o && ((d = m.clone(d, !0, !0)), f && m.merge(g, ub(d, 'script'))), b.call(
            this[j],
            d,
            j,
          );
  ...
  !(function () {
    ...
    if (
      ...
      (c.cssText = 'float:left;opacity:.5'), (k.opacity =
        c.opacity === '0.5'), (k.cssFloat = !!c.cssFloat), (b.style.backgroundClip =
      ...
      (d = a[g]), d.style &&
        (
          ...
          b
            ...
            : (
                (e = U(d)),
                ((c && c !== 'none') || !e) && m._data(d, 'olddisplay', e ? c : m.css(d, 'display'))
              )
        );
    }
    for (g = 0; h > g; g++) {
  ...
  m.extend({
    ...
    css(a, b, c, d) {
      ...
      return (b = m.cssProps[h] || (m.cssProps[h] = Ub(a.style, h))), (g =
        m.cssHooks[b] || m.cssHooks[h]), g && 'get' in g && (f = g.get(a, !0, c)), void 0 === f &&
        (f = Jb(a, b, d)), f === 'normal' && b in Sb && (f = Sb[b]), c === '' || c
  ...
  (m.Animation = m.extend(kc, {
    ...
    return (d.duration = m.fx.off
      ...
      : typeof d.duration === 'number'
        ? d.duration
        : d.duration in m.fx.speeds ? m.fx.speeds[d.duration] : m.fx.speeds._default), (d.queue ==
      null ||
      d.queue === !0) &&
    ...
    (b = y.createElement('div')), b.setAttribute('className', 't'), (b.innerHTML =
      ...
      'a',
    )[0]), (c = y.createElement('select')), (e = c.appendChild(
      y.createElement('option'),
    )), (a = b.getElementsByTagName('input')[0]), (d.style.cssText =
      'top:1px'), (k.getSetAttribute = b.className !== 't'), (k.style = /top/.test(
      d.getAttribute('style'),
    )), (k.hrefNormalized =
      d.getAttribute('href') === '/a'), (k.checkOn = !!a.value), (k.optSelected =
      e.selected), (k.enctype = !!y.createElement('form')
      .enctype), (c.disabled = !0), (k.optDisabled = !e.disabled), (a = y.createElement(
      'input',
    )), a.setAttribute('value', ''), (k.input = a.getAttribute('value') === ''), (a.value =
      't'), a.setAttribute('type', 'radio'), (k.radioValue = a.value === 't');
  }());
  const lc = /\r/g;
  m.fn.extend({
    val(a) {
        ...
        for (b = (a || '').match(E) || []; i > h; h++)          {
          if (
            (
              (c = this[h]),
              (d =
                c.nodeType === 1 && (c.className ? (` ${c.className} `).replace(uc, ' ') : ''))
            )
          ) {
            f = 0;
  ...
  (m.param = function (a, b) {
    let c,
      d = [],
      e = function (a, b) {
        (b = m.isFunction(b) ? b() : b == null ? '' : b), (d[d.length] = `${encodeURIComponent(
          a,
        ...
        return {
          send(c, d) {
            ...
            f.send((a.hasContent && a.data) || null), (b = function (c, e) {
              ...
              ? f.readyState === 4 ? setTimeout(b) : (f.onreadystatechange = Xc[g] = b)
              : b();
          },
          abort() {
            b && b(void 0, !0);
  ...
  (m.offset = {
    setOffset(a, b, c) {
      let d,
        ...
        l = m(a),
        n = {};
      k === 'static' && (a.style.position = 'relative'), (h = l.offset()), (f = m.css(
        a,
        'top',
      )), (i = m.css(a, 'left')), (j =
        (k === 'absolute' || k === 'fixed') && m.inArray('auto', [f, i]) > -1), j
        ? ((d = l.position()), (g = d.top), (e = d.left))
        : ((g = parseFloat(f) || 0), (e = parseFloat(i) || 0)), m.isFunction(b) &&
        (b = b.call(a, c, h)), b.top != null && (n.top = b.top - h.top + g), b.left != null &&
